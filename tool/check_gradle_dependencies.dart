...
// Story 5.2's re-freeze (2026-09-05): the spine-pinned `camera`
// plugin's camerax closure joins the frozen graph — one deliberate
// re-freeze for the capture dependency, on 5.1's precedent. Every
// entry the freeze moved, traced to that chain (gradle
// dependencyInsight, debugRuntimeClasspath, identical in all three
// variants):
//   - direct: :camera_android_camerax + :flutter_plugin_android_lifecycle
//     (the plugin's projects); androidx.camera:{core,camera2,camera2-pipe,
//     lifecycle,video}:1.6.1 + featurecombinationquery:1.6.1;
//     concurrent-futures[-ktx]:1.2.0 (1.1.0 up-resolved by camera-core/
//     video); androidx.core:core-backported-fixes:1.0.0 (camera-core/
//     camera2); androidx.tracing:{tracing,-android,-ktx}:1.3.0
//     (camera-lifecycle; 1.2.0 up-resolved); androidx.exifinterface
//     1.4.1→1.4.2 (camera-core 1.6.1; the embedding's 1.4.1 loses);
//     androidx.annotation 1.8.1→1.10.0 (+ -experimental 1.4.0→1.4.1,
//     flutter_plugin_android_lifecycle / camera-* / media3-common).
//   - guava family: :camera_android_camerax requests guava:33.5.0-android
//     (camera-video's 32.0.1 loses the conflict), which brings
//     failureaccess:1.0.3, j2objc-annotations:3.1,
//     error_prone_annotations:2.41.0, auto-value-annotations:1.6.3
//     (also camera-core/lifecycle/video/featurecombinationquery's own
//     direct ask) and relocates bare listenablefuture:1.0 to
//     9999.0-empty-to-avoid-conflict-with-guava.
//   - dagger family: camera-camera2/-pipe request dagger:2.59, which
//     brings jakarta.inject:jakarta.inject-api:2.0.1.
//   - coroutines: camera-camera2/camera-core request
//     kotlinx-coroutines 1.9.0 (1.7.1→1.9.0 across -android/-core/
//     -core-jvm/-bom); camera-camera2/-pipe bring atomicfu[:‑jvm]:0.28.0.
//   - media3: camera-video→media3-muxer→media3-container→media3-common
//     1.9.0; media3-common pins kotlin-bom:1.8.0, whose platform
//     alignment moves kotlin-stdlib-jdk7 1.8.20→1.8.0 and drops
//     kotlin-stdlib-jdk8:1.8.20 / kotlin-stdlib-common:2.4.0 from the
//     resolved set (kotlin-stdlib itself stays 2.4.0).
// No mover outside the camera plugin's chain — nothing constrained
// back, nothing unexplained.
// Flutter: 3.47.2; configurations: debugRuntimeClasspath, releaseRuntimeClasspath, profileRuntimeClasspath;
// generated 2026-09-05T22:16:55.359791Z by `dart run tool/check_gradle_dependencies.dart --re-freeze`.
...
const Map<String, Set<String>> gradleDependencyAllowlist = {
  'debugRuntimeClasspath': {
    ...
    'com.google.mlkit:vision-interfaces:16.1.0',
    ...
    'non-coordinate:org.jetbrains.kotlin:kotlin-stdlib -> 2.4.0',
    'non-coordinate:project :camera_android_camerax',
    'non-coordinate:project :flutter_plugin_android_lifecycle',
    'non-coordinate:project :google_mlkit_commons',
    'non-coordinate:project :google_mlkit_face_detection',
