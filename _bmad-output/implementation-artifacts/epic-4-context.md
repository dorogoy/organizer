...
- Identical corpus (exactly 10 real photographs spanning ≥ 4 distinct space types), prompt, structured-output schema and pass bar for all five — and the pass bar is written down and confirmed before the first candidate runs.
