...
| JDK | **current LTS for the build JVM** — 21, or 25 if the template's Gradle is 9.1+; 17 is the *minimum*, not the pin; bytecode level = the template's own | host has **26.0.2** (non-LTS — never used) | devbox package `jdk21` / `jdk25` (Task 1) |
