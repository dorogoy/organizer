...
- [x] [Review][Defer] Fix the later-resident fallback that renders the committed child twice [lib/ui/dispenser/dispenser_strip_layer.dart:82-103] — deferred, pre-existing; already tracked in `deferred-work.md:238-240`
