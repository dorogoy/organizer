...
- **JDK 17** comes from devbox (nixpkgs `jdk17`). The pin is the major — 17 is what the 3.47 Android toolchain verifies against (Java 17 minimum, KGP 2.4.0) — and patches float.
